...
exports.logout = exports.login = exports.getUrl = exports.getHeaders = void 0;
...
var getUrl = exports.getUrl = function getUrl(action) {
  return "/api/v1/users/".concat(action);
};
...
var updateSettings = exports.updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    var action, response, error;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          action = type === 'password' ? 'updateMyPassword' : 'updateMe';
          _context.next = 3;
          return fetch((0, _login.getUrl)(action), {
            method: 'PATCH',
            headers: (0, _login.getHeaders)(),
            body: JSON.stringify(data)
          });
        case 3:
          response = _context.sent;
...
},{"./login":"login.js","./alerts":"alerts.js"}],"booking.js":[function(require,module,exports) {
"use strict";
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          (0, _alerts.showAlert)('success', 'tour booked successfuly');
          window.setTimeout(function () {
            location.assign('/');
          }, 1500);
          _context.next = 12;
...
},{"./login":"login.js","./updateSettings":"updateSettings.js","./booking":"booking.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
